            ...
            IconButton(
              onPressed: () async {
                if(sourceTextController.text.isNotEmpty &&
                  ...
                  showSnackbar(
                    content: Text('请完成所有必填项，方可保存数据至数据库'),
                    context: context,
                  );
                }
              },
        ...
        body: ListView(
          children: [
              ...
              title: CustomInput(
                ...
                trailing: Tooltip(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      passwordTextController.text = generateStrongPassword();
                      setState(() {
            ...
            ListTile(
              ...
              subtitle: Text('常见的加密算法Plain text password、MD5 & SHA1、SHA256 + Salt、PBKDF2 + Salt、Bcrypt等，为了可逆密码，需要选择对称加密、非对称加密算法.',style: TextStyle(
                fontSize: AppResponsive.secondryFontSize.resolve(context).sp,
              ),),
            ),
          ],
